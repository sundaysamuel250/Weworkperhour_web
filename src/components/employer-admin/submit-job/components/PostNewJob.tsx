    ...
    <>
      ...
      <section className="p-8 mt-[4rem]">
            ...
            <div className="flex flex-wrap -mx-2">
              <div className="w-full sm:w-1/2 px-2 mb-4">
                ...
                <div className="relative">
                  ...
                  >
                    <span className="text-gray-500">{selectedCategory ? selectedCategory.title : 'Select Category'}</span>
              ...
              <div className="w-full sm:w-1/2 px-2 mb-4">
                ...
                <div className="relative">
                  <button
                    ...
                    onClick={toggleType}
                  >
                    <span className="text-gray-500">{selectedType?selectedType.title : 'Select Job Type'}</span>
              ...
              <div className="w-full sm:w-1/2 px-2 mb-4">
                ...
                <div className="relative">
                  ...
                  >
                    <span className="text-gray-500">{selectedWorkType ? selectedWorkType.title : 'Select Work Type'}</span>
            ...
            <div className="flex flex-wrap -mx-2">
              ...
              <div className="w-full sm:w-1/2 px-2 mb-4">
                ...
                <input id="city" value={city}
                  onChange={(e)=> {setCity(e.target.value)}} type="text" placeholder="" className="w-full border rounded-lg border-gray-300 bg-white p-2 shadow-sm focus:ring-0 focus:outline-none" />
              </div>
              <div className="w-full sm:w-1/2 px-2 mb-4">
                ...
                <select onChange={(e) => {
                  ...
                  {
                    user_state !== "" && <option value={user_state}>{user_state}</option>
                  }
                  {
                    states.map((state) => (
        ...
        <div className="flex justify-end space-x-4">
          ...
          <Button bg={"green"} isLoading={loading} onClick={()=>submit()} px={4} py={2} textColor={"white"} className="px-4 py-2 bg-green-500 text-white rounded-md" rounded={"2"}>
            Next
          </Button>
        </div>
      </section>
