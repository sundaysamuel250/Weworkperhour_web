...
const FindJobCardSection: React.FC <FindJobCardSectionProps>= ({jobType, companyLogo, workType, datePosted, slug, companyName, LocationName, jobTitle, jobDescription, payment, jobStyleOne, jobStyleTwo, jobStyleThree}) => {
