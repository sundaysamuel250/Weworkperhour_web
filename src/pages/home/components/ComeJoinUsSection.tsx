...
const ComeJoinUsSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    // Handle form submission here, such as sending the email
  ...
  return (
    <section className="xl:max-w-[1200px] lg:max-w-[1200px] md:max-w-[900px] lg:w-full md:w-[750px]  lg:mx-auto mx-[2rem] bg-[#f5f5f5] rounded-[5px]">
      <section className="lg:flex md:flex gap-[4rem] justify-center items-center p-[2.5rem]">
       <div className=""> 
        ...
        <div>
          <p className='lg:text-[14px] md:text-[14px] text-[10px] text-[#646A73] font-sans font-normal mt-[0.5rem]'>By joining us, you have made a wise decision in making your job search more transparent, easier and faster</p>
  ...
  <input
      ...
      required
    />
    <button type="submit" className="absolute inset-y-0 xl:right-[5.5rem] lg:right-[4.5rem] font-sans right-[0.5rem] bg-[#EE009D] text-[13px] text-white px-4 my-[8px] rounded-[5px]">
      Submit
    </button>
  </div>
</form>
