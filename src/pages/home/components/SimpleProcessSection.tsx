  ...
  return (
    <section className='py-[4rem] bg-[#f5f5f5] w-full'>
      <div className='text-center'>
        ...
        <h1 className='lg:text-[38px] md:text-[28px] text-[20px] mt-[0.5rem] font-sans font-semibold tracking-[1px]' >The fast and <span className='text-[#EE009D]' >simple process.</span></h1>
        <p className='lg:text-[14px] md:text-[16px] text-[10px] text-[#646A73] font-sans font-normal mt-[0.5rem]'>Weworkperhour carries the theme of technology in <br />helping you find a Job with an easy and fast process.</p>
      </div>
  ...
  <div className='grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 sm:gap-[4rem] gap-[4rem] md:gap-[4rem]'>
    <div className='text-center'>
      ...
      <div className='w-full'>
        ...
        <p className='text-sm md:text-base text-gray-600 mt-1'>Build your reputation by creating a professional resume</p>
      </div>
    </div>
    <div className='text-center'>
      <div className='mx-auto max-w-[150px]'>
      ...
      <div className='w-full'>
        <h1 className='text-lg md:text-xl lg:text-2xl mt-2 font-semibold tracking-wide'>Apply for Job</h1>
        <p className='text-sm md:text-base text-gray-600 mt-1'>Find your dream job and send a resume according to your field.</p>
      </div>
    </div>
    <div className='text-center'>
      <div className='mx-auto max-w-[150px]'>
      ...
      <div className='w-full'>
        <h1 className='text-lg md:text-xl lg:text-2xl mt-2 font-semibold tracking-wide'>Interview</h1>
        <p className='text-sm md:text-base text-gray-600 mt-1'>Point out your skills and strengths at the interview.</p>
      </div>
    </div>
    <div className='text-center'>
      <div className='mx-auto max-w-[150px]'>
      ...
      <div className='w-full'>
        ...
        <p className='text-sm md:text-base text-gray-600 mt-1'>You have completed step by step; it's time for an employment contract.</p>
      </div>
    </div>
  </div>
