  ...
  return (
    <section className="py-[4rem]">
      <section className="lg:flex items-center justify-center gap-[4rem] lg:px-[4rem] px-[2rem]">
        ...
        <h1 className="lg:text-[38px] md:text-[28px] text-[20px] mt-[1rem] font-sans font-semibold tracking-[1px]">One easy step to <br></br>change <span className="text-[#ee009d]">your future.</span></h1>
