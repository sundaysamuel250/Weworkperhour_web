...
const jobData = [
    {
        ...
        sliderDescription: "Weworkperhour is committed toproviding a fun and transparent experience for finding work with a focus on their ethos, skills and aspirations.",
        buttonName: 'View All',
        link: '/job-seekers'
    },
    {
        ...
        sliderDescription: "Weworkperhour is the best recruiting poineer, with a multiplatform based platform, transparently displaying the recruitment process, helping you get quality candidates.",
        buttonName: 'View All',
        link: '/for-companies'
    },
];
